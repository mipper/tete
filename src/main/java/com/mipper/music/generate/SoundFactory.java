...
public class SoundFactory
{
  ...
  public Sound generateSound ( NoteRange range )
    throws
      EmptyException
  {
    IntervalPattern ct = getRandomPattern ();
  ...
  public void addPatterns ( IntervalPatternRepository repository )
  {
    ...
    for ( IntervalPattern ct: repository.getPatterns () )
    {
  ...
  {
    Interval i = pattern.getLargestInterval ();
  ...
  private LinkedList<IntervalPattern> _availablePatterns = new LinkedList<IntervalPattern> ();
