This software is Copyright © 2005 Cliff Evans.
All rights reserved.
...
lack of documentation by adding some online help but pressures of work and trying
to having a life etc. may mean this takes some time to achieve.
...
The Java Runtime Environment (JRE) is available for download from Sun:
http://java.sun.com/j2se/1.5.0/download.jsp.  The JRE does not include the midi
soundbank file as default and this can be downloaded from
...
If you have associated jar files with the java runtime you will be able to double
click on the tete.jar file in the directory you unzipped the Tete files into.

Alternatively you can right click on the jar file and select Open with... and select
the java.exe from the JRE 1.5 bin directory.
